...
function preencherCards() {
    container.innerHTML = `
			<div id="model0" class="card col-lg-3 m-2 justify-content-between text-success text-center" style="height: 638px; max-height: 638px;">
				...
				<img src="../assets/noimage.jpg"
					...
					<button class="btn btn-secondary btn-outline-light oculto" data-toggle="modal" data-target="#modalVender">Vender</button>
                    <button class="btn btn-danger btn-outline-light">Excluir</button>
					<h4 class="card-footer text-right p-3 mb-2 bg-success text-white">Preço</h4>
			</div>`;
